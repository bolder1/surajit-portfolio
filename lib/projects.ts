...
export const projects: Project[] = [
  ...
  {
    slug: "cheeese",
    title: "CHEEESE — Brand Site",
    subtitle: "Direct-to-consumer brand site for a real-cheese-cube CPG product",
    category: "Website",
    confidential: false,
    access: "public",
    year: "2025",
    role: "Product Designer + Frontend · solo build",
    team: "Solo · Next.js 16 · React 19 · GSAP · Lenis · Tailwind 4",
    summary:
      "Designed and built CHEEESE — a direct-to-consumer brand site for single-bite real-cheese cubes (four flavours, four single-serve foil packs per box). Editorial-pacing, anti-CPG-template, with cinematic dark-video moments interleaved with quiet cream interludes. The cube is the icon; the copy is the voice.",
    problem:
      "Most CPG brand sites land on a generic Shopify-template surface — big white background, dish photo, 'Shop Now' button, identical to every adjacent product. The brief: build a brand site that earns attention through pacing and voice instead of decoration, while still selling boxes direct.",
    publicSections: [
      {
        heading: "Role",
        body: "Solo build. Brand voice (sentence-case CTAs, anti-hype declaratives, cube-as-house-vocabulary), full IA (home · find stores · about · products · checkout · quiz), and the frontend itself (Next.js 16 · React 19 · GSAP · Lenis · Tailwind 4). One person, one design system, one shipped surface.",
      },
      {
        heading: "Why this is in the portfolio",
        body: "Most enterprise designers can't ship a consumer brand. This is the proof I can — voice, type, pacing, motion, and code, all in one artifact.",
      },
      {
        heading: "The Bento Brand System",
        body: "The CHEEEESE brand also ships a four-flavour Bento Brand System — same DNA, distinct mood per SKU (Classic Original orange, Jalapeño Cheddar green, Roasted Garlic Herb olive, Smoky Paprika red). View the standalone brand page at /cheeese-bento — it's a separate artifact built from a Claude Design handoff, ported into Next.js with the Bagel Fat One wordmark, real-cheese stamp, hex chip strip, nutrition card, and a promo-video slot.",
      },
    ],
    tags: ["Brand", "CPG", "Consumer", "Next.js", "GSAP", "Solo build"],
    featured: true,
    order: 12,
    readingTime: "~ 4 min read",
    research: [
      {
        method: "CPG brand teardown",
        sample: "Five direct-to-consumer snack brands · two days",
        finding:
          "Every site that survived in memory had one anchor — a recurring vocabulary, a recurring colour, a recurring image type — repeated across the surface. The forgettable ones tried to be six things. We anchored on 'the cube.'",
      },
      {
        method: "Voice extraction",
        sample: "Founder's own writing + observed copy in adjacent brands",
        finding:
          "The voice was already there in the founder's emails — anti-hype, declarative, cheeky. The site's job was to amplify that voice, not invent a new one. Six characteristics codified into a PRODUCT.md and used as the lint for every line of copy.",
      },
    ],
    uxLaws: [
      {
        ...
        principle:
          "Aesthetically pleasing interfaces are perceived as more usable.",
        applied:
          "Editorial pacing, restrained typography, and one anchor colour treatment per section type. The whole site reads as 'someone made this on purpose,' which is half the battle for a CPG brand.",
      },
      {
        law: "Peak-End Rule",
        principle:
          "People judge an experience by the peak and how it ends.",
        applied:
          "The peak moment is the hero: a cinematic dark-video sequence with sentence-case copy and one button. The end moment is the post-purchase confirmation: photo-led, calm, 'your cubes are on the way.' Both moments are designed; everything between is paced.",
      },
      {
        law: "Jakob's Law",
        principle:
          "Users bring expectations from other sites.",
        applied:
          "Checkout, store-locator, and product detail follow conventions a snack-curious browser already knows. Novelty is reserved for hero, voice, and pacing — never for the buy moment.",
      },
    ],
    designDecisions: [
      {
        decision: "Editorial pacing over uniform marketing",
        rationale:
          "Most brand sites paint every section the same colour treatment. The CHEEESE site interleaves cinematic dark-video sections with quiet cream interludes and numbered card grids. Repetition kills attention; rhythm earns it.",
        tradeoff:
          "Slightly higher cognitive load on first scroll. Tested as 'feels like a magazine' — exactly the intent.",
        kind: "visual",
      },
      {
        decision: "Sentence-case CTAs, never Title Case",
        rationale:
          "Title Case CTAs ('Shop Now') signal 'every Shopify template ever.' Sentence-case CTAs ('Find your cube.') signal 'someone wrote this.' The voice carries even on the buttons.",
        tradeoff:
          "Slight friction with conversion-CRO conventions that prefer Title Case for scannability. Tested fine; the brand voice is doing the work the case treatment usually does.",
        kind: "visual",
      },
      {
        decision: "Curly punctuation everywhere; no em dashes",
        rationale:
          "Straight quotes and `...` are the typographic uniform of every cheap brand site. Curly quotes and `…` cost nothing and signal craft. No em dashes — comma/colon/period only — keeps the voice declarative, not editorial.",
        tradeoff:
          "Requires copy lint rules. Built into the PRODUCT.md as a check; engineering enforces in CI.",
        kind: "visual",
      },
    ],
    visualDecisions: [
      {
        decision: "The cube is the icon",
        rationale:
          "A real cube. Sometimes a metaphor. Always concrete. One recurring shape across the entire surface — hero · packaging · navigation · quiz · checkout — anchors the brand the way a logo can't.",
        tradeoff:
          "Less photographic variety. Acceptable; the brand wants memorability, not stock-photo bloat.",
        kind: "visual",
      },
      {
        decision: "Z-pattern for non-video sections, centred focus for video sections",
        rationale:
          "Each treatment has one job. Z-pattern reads fast and sells; centred focus stops the scroll and impresses. Mixing them in one section produces neither.",
        tradeoff:
          "Constraints the layout vocabulary. The vocabulary is the system.",
        kind: "visual",
      },
    ],
    screens: [
      {
        caption: "01 / Site overview — pacing across the home page",
        note: "Cinematic dark-video hero → cream interlude → numbered card grid → cream interlude → product showcase → CTA. Editorial pacing is the system.",
        placeholder: "dashboard",
        span: 2,
      },
      {
        caption: "02 / Voice in action — sentence case, curly punctuation, anti-hype",
        note: "\"Find your cube.\" · \"We didn't reinvent cheese. We just made it impossible to walk past.\" The voice is the design.",
        placeholder: "form",
      },
      {
        caption: "03 / Product detail + the cube as icon",
        note: "Four flavours, four foil packs per box. The cube anchors the surface; everything else is rhythm.",
        placeholder: "mobile",
      },
    ],
  },

  {
    ...
    subtitle:
      "Four flavours, four bentos — same brand DNA, distinct mood per SKU",
    category: "Website",
    confidential: false,
    /* External so the row in /work links straight to the standalone
       brand page at /cheeese-bento; internal-redirect handling in
       WorkArchive keeps the navigation in-tab. */
    access: "external",
    year: "2026",
    role: "Product Designer + Frontend · solo build",
    figmaUrl: "/cheeese-bento",
    tags: ["Brand", "CPG", "Bento", "AI-augmented", "Solo build"],
    featured: true,
    order: 13,
  },
